...
public class SoundManager : MonoBehaviour
{
    ...
    public enum SE_Type
    {
        Shot2,Shot3,Shot4,BigShot4,Shot5,BombShot,Cat2,Change1,Change2,Change3,Change4,Damage1,Damage2,Damage3,Decide,
        Move,Move2,Move3,Die,Clear,Clear2,Show,Miss,Laugh,Bomb
    }
